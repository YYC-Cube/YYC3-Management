  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">微信公众号配置</h1>
          <p className="text-muted-foreground mt-2">配置微信公众号接入参数和功能设置</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card className="bg-card/90 backdrop-blur-sm border border-primary/10 rounded-xl shadow-sm hover:shadow-xl hover:border-primary/20 transition-all duration-300 hover:scale-105 border-r-[5px] border-r-primary shadow-md">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-lg font-bold text-foreground">关注用户</p>
        ...
        <Card className="bg-card/90 backdrop-blur-sm border border-primary/10 rounded-xl shadow-sm hover:shadow-xl hover:border-primary/20 transition-all duration-300 hover:scale-105 border-r-[5px] border-r-success shadow-md">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-lg font-bold text-foreground">消息量</p>
        ...
        <Card className="bg-card/90 backdrop-blur-sm border border-primary/10 rounded-xl shadow-sm hover:shadow-xl hover:border-primary/20 transition-all duration-300 hover:scale-105 border-r-[5px] border-r-orange-500 shadow-md">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-lg font-bold text-foreground">点击量</p>
        ...
        <Card className="bg-card/90 backdrop-blur-sm border border-primary/10 rounded-xl shadow-sm hover:shadow-xl hover:border-primary/20 transition-all duration-300 hover:scale-105 border-r-[5px] border-r-purple-500 shadow-md">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-lg font-bold text-foreground">增长率</p>
            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between mb-4">
                <div className="space-y-0.5">
                  <Label>启用微信公众号</Label>
                  <p className="text-sm text-muted-foreground">开启后系统将接收微信公众号消息</p>
                </div>
                <Switch
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  disabled={!basicConfig.enabled}
                />
                <p className="text-sm text-muted-foreground">请将此URL配置到微信公众平台的服务器配置中</p>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
            ...
            <CardContent className="space-y-6">
              <div className="grid gap-6">
                {menuButtons.map((button, index) => (
                  <div key={button.id} className="border border-border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                      ...
                      <div className="space-y-2">
                        <Label>菜单类型</Label>
                        <select className="w-full p-2 border border-input rounded-md" value={button.type}>
                    ...
                    {button.subButtons && button.subButtons.length > 0 && (
                      <div className="space-y-4">
                        <h5 className="font-medium text-sm text-card-foreground">子菜单</h5>
                        {button.subButtons.map((subButton, _subIndex) => (
                          <div key={subButton.id} className="bg-muted p-3 rounded-md">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                              <div className="space-y-1">
                                <Label className="text-xs">子菜单名称</Label>
                                <Input className="text-sm" value={subButton.name} />
                              </div>
                              <div className="space-y-1">
                              ...
                              <div className="space-y-1">
                                ...
                                <Input className="text-sm" value={subButton.type === "view" ? subButton.url : subButton.key} />
                              </div>
                            </div>
                          </div>
                        ))}
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">模板ID: {template.templateId}</p>
                      </div>
                    </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="h-48 bg-muted rounded-lg flex items-center justify-center">
                    <p className="text-muted-foreground">用户增长图表</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <h4 className="font-medium">消息互动统计</h4>
                  <div className="h-48 bg-muted rounded-lg flex items-center justify-center">
                    <p className="text-muted-foreground">消息统计图表</p>
                  </div>
                </div>
              </div>
