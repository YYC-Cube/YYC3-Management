...
*本文由AI智能生成，内容仅供参考*`
  ...
  return (
    <PageContainer title="AI创作助手" description="一键生成高质量内容，并同步推送到微信公众号、企业微信、飞书、小红书等平台">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-6">
                  ...
                  <Button
                    ...
                    className="w-full py-3 px-4 bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-medium shadow-md hover:shadow-lg transition-all duration-200"
          ...
          <Card className="border-0 shadow-lg">
            ...
            <CardFooter className="flex justify-end">
              <Button
                ...
                className="py-3 px-4 bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-medium shadow-md hover:shadow-lg transition-all duration-200"
              >
                  ...
                  {history.map((item) => (
                    <Card key={item.id} className="hover:shadow-md transition-all duration-300">
                      ...
                      <CardFooter className="flex justify-between">
                        ...
                        <Button size="sm" className="py-2 px-3 bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-medium transition-all duration-200">
                          再次发布
                        </Button>
                      </CardFooter>
                    </Card>
      ...
      <div className="mt-8 p-6 bg-linear-to-r from-indigo-50 to-purple-50 rounded-xl border border-indigo-200">
