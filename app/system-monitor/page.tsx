              ...
              <div className="flex flex-wrap items-center gap-4 sm:gap-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="px-2 py-1 border border-input rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
        ...
        <Tabs defaultValue="services" className="responsive-spacing">
            ...
            <div className="responsive-grid-2">
              <Card className="responsive-card border-r-[5px] border-r-primary shadow-md">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-muted-foreground">总体使用率</span>
              ...
              <Card className="responsive-card border-r-[5px] border-r-purple-500 shadow-md">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-muted-foreground">网络使用率</span>
          ...
          <TabsContent value="security" className="responsive-spacing">
            <div className="responsive-grid-3">
              ...
              <Card className="responsive-card border-r-[5px] border-r-yellow-500 shadow-md">
                <CardHeader>
                  <CardTitle className="text-base sm:text-lg flex items-center">
            ...
            <Card className="responsive-card border-r-[5px] border-r-indigo-500 shadow-md">
              <CardHeader>
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <select className="px-3 py-1 border border-input rounded text-xs focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option>应用日志</option>
                    <option>错误日志</option>
                    <option>访问日志</option>
                  </select>
